...
const Header: preact.ComponentType = () => {
  return (
    <header class="flex justify-between items-center px-2 py-1.5 bg-neutral-950 border-b border-neutral-800 z-10">
      ...
      <div class="flex items-center text-[10px] text-gray-500 hover:text-white hover:underline cursor-pointer">
        <span class="bg-neutral-800 px-2 py-0.5 rounded">{dashBoardData.map}</span>
      </div>
    </header>
  );
};
